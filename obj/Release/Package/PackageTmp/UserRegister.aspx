    ...
    <form id="form1" runat="server">
        <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-cell weui-cell_vcode">
                ...
                <div class="weui-cell__bd">
                    <input id="tel" runat="server" class="weui-input" type="tel" placeholder="请输入手机号" required/>
                </div>
                <div class="weui-cell__ft">
                    <button type="button" ID="vcodeBtn"  class="weui-vcode-btn" runat="server" OnClick="vcodeBtn_Click">获取验证码</button>
                </div>
            </div>
            <!--  -->
            <!--<div class="weui-cell">
            ...
            <div class="weui-cell ">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="number" placeholder="请输入手机收到的验证码" required/>
                </div>
            </div>
            <!-- 注册身份 -->
            ...
            <div id="addition-yyw" style="display: none;">
                <div class="weui-cell">
                    ...
                    <div class="weui-cell__bd">
                        <input class="weui-input" type="number" pattern="[0-9xX]{18}" placeholder="请输入18位身份证">
                    </div>
                </div>
            </div>
            <!-- 附加信息-经销商 -->
        ...
        <script>
            ...
            $('[name=select1]').on('change', function () {
                if (this.value == 1) {
                    ...
                    $('#addition-yyw,#addition-jxs').find('input').attr('require');
            ...
            $uploaderInput.on('change', function (e) {
                ...
                var fileCount = files.length + parseInt($('.weui-uploader__info').text().split('/')[0]);
                if (fileCount > 5) {
                    alert('图片数量不能超过5张！');
                    return;
                }
                ...
                $('.weui-uploader__info').text(fileCount + '/5');
            });
            /* 图片查看删除 */
