<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivitySignSuccess.aspx.cs" Inherits="WXShare.ActivitySignSuccess" %>
        ...
        <div class="page msg_success js_show">
            <div class="weui-msg">
                ...
                <div class="weui-msg__text-area">
                    ...
                    <p class="weui-msg__desc">请保持手机畅通<br/>我们的工作人员将会尽快与您联系</p>
                </div>
                <div id="qrcode" class="weui-msg__opr-area">
                    <img src="./images/qrcode.png" style="height: 100%;">
                </div>
                <div class="weui-msg__text-area">
                    <p class="weui-msg__desc">关注公众号，查看更多活动<br/> 分享活动可获得返利</p>
                </div>
